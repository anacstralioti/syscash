        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-4 d-flex justify-content-start">
                    ...
                    <a href="favorecido_pdf.php" class="btn btn-primary btn-sm" title="Imprimir" id="botao_imprimir_categoria" target="_blank"><i class="fas fa-print"></i>&nbsp;Imprimir</a>
                </div>
                <div class="col-md-4 d-flex justify-content-center">
                </div>
                <div class="col-md-4 d-flex justify-content-end">
